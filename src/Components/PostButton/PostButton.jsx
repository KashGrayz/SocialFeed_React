    ...
    function handleDislike(){
        ...
        return (
            <div className='container'>
                <div>
                    <button type='button' className={likeClass} onClick={handleLike}>
                ...
                <div>
                    <button type='button' className={dislikeClass} onClick={handleDislike}><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-hand-thumbs-down" viewBox="0 0 16 16">
